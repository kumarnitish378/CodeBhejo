...
def generate_file_bhejo_pdf(qr_code_file_name, user_id, name=""):
    ...
    # Heading 1
    heading1 = Paragraph(f"<font color='%s'><b>Code Bhejo Id: {user_id}</b></font>" % color_codes['blue'], heading1_style)
    heading1.hAlign = "CENTER"
    story.append(heading1)

    # Heading 2
    heading2 = Paragraph("Quick Code Sharing with www.codebhejo.in", heading2_style)
    ...
    copyright_text = "<font color='%s'>© 2023 Udian Tower | CodeBhejo. All rights reserved. | Free to use.</font>" % color_codes['dark_blue']
